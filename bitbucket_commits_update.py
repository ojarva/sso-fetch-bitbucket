...
def get_tzinfo_from_dt(dt1, dt2):
    ...
    return "%s%02d:%02d" % (pr, hours, minutes)
        ...
        for repo in repositories:
            ...
            while process:
               ...
               for commit in commits["changesets"]:
                   ...
                   if not author.endswith("@futurice.com"):
                       continue
                   ...
                   if timestamp > last_processed:
                       ...
                       # No need to fetch older entries
                       break
               else:
                   # for was not interrupted -> fetch next round
                   process = True
               if len(commits["changesets"]) == 1:
                   # Only one commit -- namely, start. Break.
                   break
